...
void my_touchpad_read( lv_indev_t * indev, lv_indev_data_t * data )
{
  if(touchscreen.touched())
  {
    ...
    data->point.x = TFT_HOR_RES - map(p.y, touchScreenMinimumY, touchScreenMaximumY, 1, TFT_HOR_RES); /* Touchscreen X calibration */
    data->point.y = map(p.x, touchScreenMinimumX, touchScreenMaximumX, 1, TFT_VER_RES); /* Touchscreen Y calibration */
